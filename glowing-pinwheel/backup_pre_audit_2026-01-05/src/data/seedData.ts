...
export const SEED_TVS: Product[] = [
    ...
    },
    {
        ...
        model: 'X90K',
        price: 3999,
        imageUrl: '/images/products/sony-x90k.jpg',
        scores: {
...
export const SEED_FRIDGES: Product[] = [
    {
        ...
        model: 'BRM56',
        price: 3899,
        imageUrl: '/images/products/brastemp-brm56.jpg',
        scores: {
    ...
    },
    {
        ...
        model: 'RF23',
        price: 7499,
        imageUrl: '/images/products/samsung-rf23.jpg',
        scores: {
    ...
    },
    {
        ...
        model: 'GS-B395',
        price: 3199,
        imageUrl: '/images/products/lg-gsb395.jpg',
        scores: {
    ...
    },
    {
        ...
        model: 'NR-BT55',
        price: 4299,
        imageUrl: '/images/products/panasonic-nr-bt55.jpg',
        scores: {
...
export const SEED_AIR_CONDITIONERS: Product[] = [
    {
        ...
        model: 'S4-Q12JA31A',
        price: 2599,
        imageUrl: '/images/products/lg-dual-inverter.jpg',
        scores: {
    ...
    },
    {
        ...
        model: 'AR12CVFAMWK',
        price: 2899,
        imageUrl: '/images/products/samsung-windfree.jpg',
        scores: {
    ...
    },
    {
        ...
        model: 'EI09F',
        price: 1699,
        imageUrl: '/images/products/electrolux-eco.jpg',
        scores: {
    ...
    },
    {
        ...
        model: 'CBN12CBBNA',
        price: 2199,
        imageUrl: '/images/products/consul-inverter.jpg',
        scores: {
...
export const SEED_NOTEBOOKS: Product[] = [
    ...
    },
    {
        ...
        model: 'AN515-58',
        price: 5499,
        imageUrl: '/images/products/acer-nitro-5.jpg',
        scores: {

...
export function ComparisonTable({ products, category }: ComparisonTableProps) {
    ...
    const rankedProducts = [...products].sort((a, b) => b.computed.overall - a.computed.overall);
                        ...
                        >
                            ...
                            <div className="flex items-start gap-3 mb-4">
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    <p className="text-data text-lg font-bold text-brand-core">
                            ...
                            <div className={cn(
                                ...
                                <p className={cn(
                                    ...
                                    {product.computed.overall.toFixed(1)}
                                </p>
                            </div>
                        </div>
                    );
                    ...
                    >
                        ...
                        {products.map((product) => {
                            ...
                            return (
                                <div
                                    key={product.id}
                                    className={cn('p-4 text-center', isLowest ? 'bg-emerald-50' : '')}
                                >
                                    <span className="text-data font-bold text-brand-core">
                                        {formatPrice(product.price)}
                                    </span>
                                </div>
                            );
                    ...
                    <table className="w-full min-w-[500px]">
                        ...
                        <tbody>
                            ...
                            <tr className="border-b border-gray-100 bg-gray-50/50">
                                ...
                                <DifferenceCell
                                    value={formatPrice(productA.price)}
                                    isWinner={productA.price < productB.price}
                                    productId={productA.id}
                                />
                                <DifferenceCell
                                    value={formatPrice(productB.price)}
                                    isWinner={productB.price < productA.price}

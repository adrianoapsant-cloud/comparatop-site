...
const TCOBreakdownCard = memo(function TCOBreakdownCard({ breakdown }: TCOBreakdownCardProps) {
    ...
    // 3. Revenda: preço × (1 - depreciação)^anos
    ...
    // ========================================
    // CUSTO REAL = Preço + Energia + Manutenção - Revenda
    // ========================================

...
export function AffiliateButtons({
    ...
    // Generate URLs with safe-link patterns
    const generateUrl = (platform: string, customUrl?: string): string => {
        ...
        switch (platform) {
            ...
            case 'shopee':
                return `https://shopee.com.br/search?keyword=${encodedName}&official_mall=1`;
            case 'magalu':
                return `https://www.magazineluiza.com.br/busca/${encodedName}/?seller=magazineluiza`;
            default:
                return '#';
        }
    };
    ...
    const buttons: ButtonConfig[] = [
        {
            ...
            specialStyle: 'ring-2 ring-white ring-offset-2 ring-offset-[#FF9900]', // Double ring effect
            url: generateUrl('amazon', amazonUrl),
        },
        {
            id: 'mercadolivre',
            name: 'Conferir Desconto',
            ...
            url: generateUrl('mercadolivre', mercadoLivreUrl),
        },
        {
            id: 'shopee',
            name: 'Conferir Desconto',
            ...
            textColor: 'text-white',
            hoverEffect: 'hover:brightness-110 hover:-translate-y-0.5',
            url: generateUrl('shopee', shopeeUrl),
        },
        {
            id: 'magalu',
            name: 'Conferir Desconto',
            ...
            textColor: 'text-white',
            hoverEffect: 'hover:brightness-110 hover:-translate-y-0.5',
            url: generateUrl('magalu', magaluUrl),
        },
    ];

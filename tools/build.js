...
function generateComparisonContent(productA, productB, category) {
    ...
    <style>
        ...
        @media (max-width: 768px) {
            ...
            /* Mobile sticky column for specs table */
            .comparison-table-scroll { overflow-x: auto; -webkit-overflow-scrolling: touch; border: 1px solid #e2e8f0; border-radius: 8px; }
            .comparison-table th:first-child, .comparison-table td:first-child { position: sticky; left: 0; z-index: 2; background: white; min-width: 100px; box-shadow: 2px 0 5px rgba(0,0,0,0.1); }
            .comparison-table th:first-child { background: #1e40af; z-index: 3; }
            .comparison-table th, .comparison-table td { padding: 0.5rem 0.35rem; font-size: 0.78rem; }
        }
    </style>
    `;
}
